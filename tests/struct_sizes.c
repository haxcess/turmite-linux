...
int main(void) {
    ...
    printf("offsetof(Ant: flags=%zu x=%zu y=%zu rule=%zu tokens_fp=%zu token_rate=%zu capacity=%zu weight=%zu rng_state=%zu)\n",
           ...
           offsetof(Ant, weight), offsetof(Ant, rng_state));
}
